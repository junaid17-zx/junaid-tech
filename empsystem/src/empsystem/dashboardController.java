...
public class dashboardController implements Initializable {
    ...
    @FXML
    private TableColumn<employeeData, String> addEmployee_col_attendance;
    ...
    @FXML
    private ComboBox<?> addEmployee_attendance;
    ...
    @FXML
    private TableColumn<employeeData, String> salary_col_fine;

    @FXML
    private TextField salary_employeeID;
    
    @FXML
    private TextField salary_fine;
    
    @FXML
    private Button salary_fineBtn;
    ...
    public void addEmployeeAdd() {
        ...
        String sql = "INSERT INTO employee "
                + "(employee_id,firstName,lastName,gender,phoneNum,position,image,date ,attendance) "
                + "VALUES(?,?,?,?,?,?,?,?,?)";
        ...
        try {
            ...
            if (addEmployee_employeeID.getText().isEmpty()
                    || addEmployee_attendance.getSelectionModel().getSelectedItem() == null
                ...
                if (result.next()) {
                    ...
                    int atd;
                    prepare = connect.prepareStatement(sql);
                    addEmployee_attendance.getSelectionModel().getSelectedItem();
                    ...
                    prepare.setString(9, (String) addEmployee_attendance.getSelectionModel().getSelectedItem());
                    prepare.executeUpdate();

                    String insertInfo = "INSERT INTO employee_info "
                            + "(employee_id,firstName,lastName,position,salary,date,fine) "
                            + "VALUES(?,?,?,?,?,?,?)";
    ...
    public void addEmployeeUpdate() {
        ...
        String sql = "UPDATE employee SET firstName = '"
                ...
                + uri + "', date = '" + sqlDate  + "', attendance = '"
                + addEmployee_attendance.getSelectionModel().getSelectedItem() + "' WHERE employee_id ='"
                + addEmployee_employeeID.getText() + "'";
    ...
    public void addEmployeeReset() {
        ...
        addEmployee_attendance.getSelectionModel().clearSelection();
    ...
    public void addEmployeeInsertImage() {
        ...
        if (file != null) {
            ...
            image = new Image(file.toURI().toString(), 110, 130, false, true);
            addEmployee_image.setImage(image);
        }
    }
    
    private String[] positionList = {"Frontend Developer", "Backend Developer", "App Developer", "Full Stack Developer","Web Designer", "Data Engineer", "Internee" };
    ...
    private String[] listGender = {"Male", "Female", "Prefer not to say"};
    ...
    private String[] listAttendance = {"Present", "Absent"};

    public void addEmployeeAttendanceList() {
        List<String> listA = new ArrayList<>();
        List<Integer> listB = new ArrayList<>();

        for (String data : listAttendance) {
            listA.add(data);
            if(data=="Present"){
                listB.add(+1);
            }
        ...
        addEmployee_attendance.setItems(listData);
    ...
    public ObservableList<employeeData> addEmployeeListData() {
        ...
        try {
            prepare = connect.prepareStatement(sql);
            result = prepare.executeQuery();
            employeeData employeeA;

            while (result.next()) {

                    employeeA = new employeeData(
    ...
    public void addEmployeeShowListData() {
        ...
        addEmployee_col_attendance.setCellValueFactory(new PropertyValueFactory<>("attendance"));
     ...
     public void addEmployeeSelect() {
        ...
        image = new Image(uri, 110, 130, false, true);
        addEmployee_image.setImage(image);
    }
    ...
    public void salaryShowListData() {
        ...
        salary_col_fine.setCellValueFactory(new PropertyValueFactory<>("fine"));
    ...
    public void salarySelect() {
        ...
        salary_fine.setText(String.valueOf(employeeD.getFine()));

    }
    
    public void defaultNav() {
        home_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #4247a6, #2d3dd0);");
    }
    ...
    public void switchForm(ActionEvent event) {
        ...
        if (event.getSource() == home_btn) {
            ...
            addEmployee_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #4247a6, #2d3dd0);");
            home_btn.setStyle("-fx-background-color:transparent");
            salary_btn.setStyle("-fx-background-color:transparent");

            addEmployeeGendernList();
            addEmployeeAttendanceList();
            ...
            salary_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #4247a6, #2d3dd0);");
            addEmployee_btn.setStyle("-fx-background-color:transparent");
            home_btn.setStyle("-fx-background-color:transparent");
